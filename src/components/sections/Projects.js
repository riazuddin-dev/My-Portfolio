...
const projects = [
  {
    ...
    description:
      "An agentic AI knowledge platform that reasons over your data — built with a modern full-stack stack and Groq-powered intelligence.",
    tech: ["Next.js", "Express", "MongoDB", "Groq AI"],
  ...
  },
  {
    ...
    description:
      "A polished real estate experience for browsing and discovering properties — responsive UI, clean flows, and production-ready Next.js.",
    tech: ["Next.js", "Real Estate", "Vercel"],
  ...
  },
  {
    ...
    description:
      "A complete full-stack product experience focused on performance, clarity, and a refined modern interface from end to end.",
    tech: ["Full-Stack", "Next.js", "API"],
...
export function Projects() {
  ...
  return (
    ...
    >
      <div className="flex-1 flex w-full relative items-center justify-between z-10">
        ...
        <div className="flex flex-col xl:flex-row justify-start items-start xl:items-center w-full max-w-[1280px] mr-auto relative gap-8 lg:gap-16 md:pl-12 lg:pl-16 transition-all duration-700 ease-out">
          ...
          >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-[2rem] sm:text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] font-medium tracking-tight text-white leading-[1.1] mb-6"
            >
              PROJECTS THAT <br />
              TELL <br />
            ...
            >
              ...
              <svg
                ...
                className="text-white/30 group-hover:text-[#c49a6c] transition-colors group-hover:translate-x-1"
              >
          ...
          {/* Right Side Grid — 2×2 for four featured projects */}
          <motion.div
            variants={staggerContainer}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-5 w-full xl:max-w-[780px] pr-2 md:pr-4 pb-20 md:pb-10 relative z-20 mt-4 md:mt-0"
          >
            {projects.map((project, index) => (
              <motion.a
                ...
                rel="noopener noreferrer"
                key={project.id}
                className="group relative flex flex-col sm:flex-row bg-[#050505]/95 border border-white/5 rounded-[16px] overflow-hidden hover:border-[#c49a6c]/40 transition-all duration-500 hover:shadow-lg hover:shadow-[#c49a6c]/15 hover:-translate-y-1.5"
              >
                ...
                {/* Image Container */}
                <div className="relative w-full h-[180px] sm:h-auto sm:min-h-[200px] sm:w-[42%] shrink-0 overflow-hidden bg-[#000]">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#050505]/90 z-10 pointer-events-none" />
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/5 transition-colors duration-700 z-10 pointer-events-none" />
                  ...
                  <Image
                    ...
                    className="object-cover object-center group-hover:scale-[1.06] transition-transform duration-1000 ease-[0.16,1,0.3,1] opacity-70 group-hover:opacity-100"
                  />
                  ...
                  <div className="absolute top-5 left-5 z-20">
                    <div className="px-2.5 py-0.5 rounded-[4px] border border-[#c49a6c]/40 bg-black/80 group-hover:border-[#c49a6c] group-hover:bg-[#c49a6c]/20 transition-all duration-500 shadow-sm">
                      <span className="font-mono text-[9px] text-[#c49a6c] tracking-wider">
                        {project.id}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-4 left-5 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-black/70 border border-emerald-500/40 font-mono text-[8px] tracking-widest uppercase text-emerald-400/90">
                ...
                <div className="p-6 sm:p-7 flex flex-col flex-1 relative z-10 justify-center bg-[#050505]/90 group-hover:bg-[#0a0705]/90 transition-colors duration-700 border-l border-white/5 group-hover:border-[#c49a6c]/30">
                  ...
                  <div className="absolute top-5 right-5 z-20 opacity-30 group-hover:opacity-100 transition-opacity duration-500">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="text-white group-hover:text-[#c49a6c] transition-colors duration-500 group-hover:scale-110 transform"
                    >
                  ...
                  <h3 className="text-[13px] font-medium tracking-widest uppercase text-white mb-1.5 group-hover:text-[#c49a6c] transition-colors duration-500 line-clamp-1 mt-2 sm:mt-0">
                    {project.title}
                  </h3>

                  <p className="font-mono text-[9px] tracking-[0.2em] uppercase text-[#c49a6c]/70 mb-3 group-hover:text-[#c49a6c] transition-colors duration-500">
                    {project.subtitle}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mt-auto">
                    {project.tech.map((t, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 rounded-full bg-[#111] border border-white/10 text-white/40 font-mono text-[8px] uppercase tracking-widest group-hover:border-[#c49a6c]/50 group-hover:text-[#c49a6c] group-hover:bg-[#c49a6c]/10 transition-all duration-500"
                      >
                        {t}
                      </span>
                    ))}
      ...
      >
        <span className="font-mono text-[9px] tracking-[0.3em] uppercase text-[#c49a6c]">
          SCROLL
        </span>
        <motion.div
          animate={{ y: [0, 4, 0] }}
